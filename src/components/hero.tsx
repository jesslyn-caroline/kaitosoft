function Hero() {
    ...
    return (
        <section className={`lg:min-h-screen w-full h-screen md:h-fit lg:h-screen px-6 sm:px-10 lg:px-24 pt-18 md:pt-32 lg:pt-18 pb-12`}>
            <div className={`w-full h-full lg:bg-[#F4F8FB] rounded-lg flex flex-col sm:flex-row lg:flex-row justify-center sm:gap-5`}>
                ...
                <div className={`w-full mt-16 sm:mt-0 md:pl-0 lg:w-1/2 lg:pr-12 lg:pl-6 flex items-center justify-center`}>
