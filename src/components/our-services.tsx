...
function OurServices() {
    return (
        <section className={`w-full h-screen md:h-fit lg:h-screen px-6 sm:px-10 lg:px-24 pb-12 flex flex-col gap-3`}>
            <div>
                <h2 className={`text-primary text-lg font-semibold`}>Our Services</h2>
            ...
            <div className={`flex flex-col sm:grid sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-10`}>
                <div className={`bg-accent-2 py-6 md:py-8 px-6 sm:px-2 md:px-10 rounded-xl flex flex-col gap-1.5`}>
